public class CustomArrayQueue {
    ...
    public static void main(String[] args) {
        ...
        int position = queue.search(13);
        if (position != -1) {
            System.out.println("This element is found in the queue in position: " + position);
        } else {
            System.out.println("This element is not found in the queue");
        }
